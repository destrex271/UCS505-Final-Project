...
output: main.o utils.o pacman.o game.o shapes.o commons.o pellet.o ghost.o
	$(CC) main.o utils.o pacman.o game.o shapes.o pellet.o ghost.o commons.o -o output $(DFLAGS)
